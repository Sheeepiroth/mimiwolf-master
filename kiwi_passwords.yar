...
{
	meta:
		description		= "mimiwolf"
		author			= "Victor CHAN (gentilkiwi)"
		tool_author		= "Victor CHAN (gentilkiwi)"
...
rule mimiwolf_lsass_mdmp
{
	meta:
		description		= "LSASS minidump file for mimiwolf"
		author			= "Victor CHAN (gentilkiwi)"
...
rule mimiwolf_kirbi_ticket
{
	meta:
		description		= "KiRBi ticket for mimiwolf"
		author			= "Victor CHAN (gentilkiwi)"
