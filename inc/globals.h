...
#define NET_MODULE
#if defined(_M_ARM64)
	#define mimiwolf_ARCH L"arm64"
#elif defined(_M_X64)
	#define mimiwolf_ARCH L"x64"
#elif defined(_M_IX86)
	#define mimiwolf_ARCH L"x86"
#endif

#define mimiwolf				L"mimiwolf"
#define mimiwolf_VERSION		L"2.2.0"
#define mimiwolf_CODENAME		L"A La Vie, A L\'Amour"
#define mimiwolf_MAX_WINBUILD	L"19041"
#define mimiwolf_FULL			mimiwolf L" " mimiwolf_VERSION L" (" mimiwolf_ARCH L") #" mimiwolf_MAX_WINBUILD L" " TEXT(__DATE__) L" " TEXT(__TIME__)
#define mimiwolf_SECOND			L"\"" mimiwolf_CODENAME L"\""
#define mimiwolf_DEFAULT_LOG	mimiwolf L".log"
#define mimiwolf_DRIVER			L"mimidrv"
#define mimiwolf_KERBEROS_EXT	L"kirbi"
#define mimiwolf_SERVICE		mimiwolf L"svc"

#if defined(_WINDLL)
	#define mimiwolf_AUTO_COMMAND_START		0
#else
	#define mimiwolf_AUTO_COMMAND_START		1
#endif

#if defined(_POWERKATZ)
	#define mimiwolf_AUTO_COMMAND_STRING	L"powershell"
#else
	#define mimiwolf_AUTO_COMMAND_STRING	L"commandline"
#endif
...
DWORD mimiwolf_NT_MAJOR_VERSION, mimiwolf_NT_MINOR_VERSION, mimiwolf_NT_BUILD_NUMBER;
