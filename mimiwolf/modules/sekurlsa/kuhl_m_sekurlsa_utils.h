...
typedef struct _KIWI_MSV1_0_LIST_61_ANTI_mimiwolf {
	struct _KIWI_MSV1_0_LIST_61_ANTI_mimiwolf *Flink;
	struct _KIWI_MSV1_0_LIST_61_ANTI_mimiwolf *Blink;
	PVOID unk0;
	ULONG unk1;
	PVOID unk2;
	ULONG unk3;
	...
	ULONG unk22;
	PVOID CredentialManager;
} KIWI_MSV1_0_LIST_61_ANTI_mimiwolf, *PKIWI_MSV1_0_LIST_61_ANTI_mimiwolf;
